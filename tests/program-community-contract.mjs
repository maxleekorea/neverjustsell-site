...
assert(systemOperations.includes('cancellationBody.refund_method_code = ["I"]'), "non-PG bank-deposit cancellation must send Cafe24 refund method I as an array without inventing bank details");
