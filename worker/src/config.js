...
export const CAFE24_ADMIN_SCOPES = ["mall.read_product", "mall.write_product", "mall.read_order", "mall.write_order", "mall.read_category", "mall.write_category", "mall.read_store", "mall.write_store"];
